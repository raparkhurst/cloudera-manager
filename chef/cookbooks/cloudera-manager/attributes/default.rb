...
# Nginx settings - Nifi
#
# TODO - add component for NIFI as add-on or provide built 3rd party parcel!
#
default['cloudera_manager']['nginx']['nifi']['home_dir'] = '/etc/nginx'
default['cloudera_manager']['nginx']['nifi']['ssl_dir'] = '/etc/nginx/ssl'
default['cloudera_manager']['nginx']['nifi']['sites_available_dir'] = '/etc/nginx/sites-available'
default['cloudera_manager']['nginx']['nifi']['sites_enabled_dir'] = '/etc/nginx/sites-enabled'
default['cloudera_manager']['nginx']['nifi']['ssl_enabled'] = true
default['cloudera_manager']['nginx']['nifi']['ssl_csr_file'] = "#{node['hostname']}.csr"
default['cloudera_manager']['nginx']['nifi']['ssl_key_file'] = "#{node['hostname']}.key"
default['cloudera_manager']['nginx']['nifi']['ssl_crt_file'] = "#{node['hostname']}.crt"
default['cloudera_manager']['nginx']['nifi']['int_port_fwd'] = 8080
default['cloudera_manager']['nginx']['nifi']['hostname'] = node['hostname']
default['cloudera_manager']['nginx']['cloudera_manager']['site_name'] = "nifi"
