...
when 'postgres'
  ...
  node.normal_unless['cloudera_manager']['sentry']['database_name'] = node['atlassian']['sentry']['database_name']
  ...
  postgresql_access "allow_access_to_user #{node['atlassian']['sentry']['database_user']}" do
  ...
  node.default_unless['cloudera_manager']['sentry']['database_name'] = node['atlassian']['sentry']['database_name']
